...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`crmdb` /*!40100 DEFAULT CHARACTER SET ujis */;
...
CREATE TABLE `order_course` (
  ...
  `last_update` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=68 DEFAULT CHARSET=utf8 COMMENT='签单课程信息';

/*Data for the table `order_course` */

LOCK TABLES `order_course` WRITE;

insert  into `order_course`(`id`,`order_id`,`course_type`,`charger_id`,`status`,`order_attach_id`,`hour`,`cost_hour`,`schedule_hour`,`create_time`,`last_update`) values (65,21,'2',19,'1',0,60,2,60,'2015-04-24 16:18:59','2015-04-25 21:11:58'),(66,21,'1',20,'1',0,50,0,0,'2015-04-24 16:19:03','2015-04-24 22:15:45'),(67,21,'4',22,'0',0,10,0,0,'2015-04-24 22:15:45','2015-04-24 22:15:45');
