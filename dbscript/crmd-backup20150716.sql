...
insert  into `order_course`(`id`,`order_id`,`course_type`,`charger_id`,`status`,`order_attach_id`,`hour`,`cost_hour`,`schedule_hour`,`create_time`,`last_update`) values (23,10,'2',29,'1',0,50,0,50,'2015-07-16 22:33:01','2015-07-16 22:49:00'),(24,10,'1',31,'1',0,50,0,50,'2015-07-16 22:33:01','2015-07-16 22:53:35');
...
CREATE TABLE `order_course_hour_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=93 DEFAULT CHARSET=utf8 COMMENT='课时消耗记录';
