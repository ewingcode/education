...
CREATE TABLE `order_course` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=utf8 COMMENT='签单课程负责人记录表';

/*Data for the table `order_course` */

LOCK TABLES `order_course` WRITE;

insert  into `order_course`(`id`,`order_id`,`course_type`,`charger_id`,`create_time`,`last_update`,`status`,`order_attach_id`,`hour`) values (54,13,'7',19,'2015-04-06 23:20:36','2015-04-06 23:25:57','1',0,50),(55,13,'8',22,'2015-04-06 23:20:36','2015-04-06 23:25:57','1',0,50),(56,14,'3',NULL,'2015-04-06 23:26:33','2015-04-06 23:26:33','0',0,50),(57,14,'2',NULL,'2015-04-06 23:26:33','2015-04-06 23:26:33','0',0,50);
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='签单表';

/*Data for the table `order_info` */

LOCK TABLES `order_info` WRITE;

insert  into `order_info`(`id`,`order_no`,`student_id`,`fee`,`order_type`,`status`,`des`,`flow_ins_id`,`start_time`,`end_time`,`grade`,`course_hour`,`cost_course_hour`,`run_status`,`parent_order_id`,`cur_operator`,`is_last`,`create_time`,`last_update`) values (13,'no1111',1,1200000,'0','审批通过',NULL,NULL,'2015-04-06 00:00:00','2015-04-30 00:00:00','1',100,NULL,'2',NULL,18,'0','2015-04-06 23:20:36','2015-04-06 23:25:57'),(14,'no11112',1,120000,'0','教务部处理',NULL,NULL,'2015-04-06 00:00:00','2015-05-08 00:00:00','2',100,NULL,'0',NULL,18,'0','2015-04-06 23:26:33','2015-04-06 23:26:48');
...
CREATE TABLE `order_rel_his` (
  ...
  `task_id` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=72 DEFAULT CHARSET=utf8 COMMENT='签单参与者历史表';

/*Data for the table `order_rel_his` */

LOCK TABLES `order_rel_his` WRITE;

insert  into `order_rel_his`(`id`,`order_id`,`task_name`,`chargerType`,`operator`,`create_time`,`last_update`,`task_id`) values (63,13,'签约','1',18,'2015-04-06 23:20:36','2015-04-06 23:20:36',1),(64,13,'销售主管审批','2',18,'2015-04-06 23:21:51','2015-04-06 23:21:51',2),(65,13,'教务部处理','3',18,'2015-04-06 23:22:04','2015-04-06 23:22:04',3),(66,13,'班主任处理中','4',18,'2015-04-06 23:22:34','2015-04-06 23:22:34',5),(67,13,'班主任处理中','4',18,'2015-04-06 23:23:53','2015-04-06 23:23:53',5),(68,13,'班主任处理中','4',18,'2015-04-06 23:25:42','2015-04-06 23:25:42',5),(69,13,'教务部审批','3',18,'2015-04-06 23:25:57','2015-04-06 23:25:57',6),(70,14,'签约','1',18,'2015-04-06 23:26:33','2015-04-06 23:26:33',1),(71,14,'销售主管审批','2',18,'2015-04-06 23:26:48','2015-04-06 23:26:48',2);
...
CREATE TABLE `order_trace` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=107 DEFAULT CHARSET=utf8 COMMENT='签单流程跟踪表';

/*Data for the table `order_trace` */

LOCK TABLES `order_trace` WRITE;

insert  into `order_trace`(`id`,`order_id`,`task_name`,`role_id`,`user_id`,`operator`,`oper`,`create_time`,`last_update`,`oper_sort`,`task_id`,`transition`) values (94,13,'签约',1,NULL,18,'0','2015-04-06 23:20:36','2015-04-06 23:20:36',NULL,1,'待审批'),(95,13,'销售主管审批',2,NULL,18,'0','2015-04-06 23:20:36','2015-04-06 23:21:51',NULL,2,'通过'),(96,13,'教务部处理',NULL,14,18,'0','2015-04-06 23:21:51','2015-04-06 23:22:04',NULL,3,'分配任务'),(97,13,'班主任处理中',NULL,17,18,'0','2015-04-06 23:22:04','2015-04-06 23:22:34',NULL,5,'确认'),(98,13,'教务部审批',NULL,14,18,'1','2015-04-06 23:22:34','2015-04-06 23:23:36',NULL,6,'不通过'),(99,13,'班主任处理中',NULL,18,18,'0','2015-04-06 23:23:36','2015-04-06 23:23:53',NULL,5,'确认'),(100,13,'教务部审批',NULL,14,18,'1','2015-04-06 23:23:53','2015-04-06 23:24:31',NULL,6,'不通过'),(101,13,'班主任处理中',NULL,18,18,'0','2015-04-06 23:24:31','2015-04-06 23:25:42',NULL,5,'确认'),(102,13,'教务部审批',NULL,14,18,'0','2015-04-06 23:25:42','2015-04-06 23:25:57',NULL,6,'通过'),(103,13,'审批通过',NULL,NULL,NULL,NULL,'2015-04-06 23:25:57','2015-04-06 23:25:57',NULL,7,NULL),(104,14,'签约',1,NULL,18,'0','2015-04-06 23:26:33','2015-04-06 23:26:33',NULL,1,'待审批'),(105,14,'销售主管审批',2,NULL,18,'0','2015-04-06 23:26:33','2015-04-06 23:26:48',NULL,2,'通过'),(106,14,'教务部处理',NULL,14,NULL,NULL,'2015-04-06 23:26:48','2015-04-06 23:26:48',NULL,3,NULL);
