...
CREATE TABLE `course_period` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='排课时间设置';
...
CREATE TABLE `course_schedule` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='排课计划';

/*Data for the table `course_schedule` */

LOCK TABLES `course_schedule` WRITE;

insert  into `course_schedule`(`id`,`teacher_id`,`student_id`,`course_type`,`total_course_hour`,`total_cost_hour`,`start_date`,`end_date`,`week_days`,`start_time`,`end_time`,`status`,`iseff`,`create_time`,`last_update`) values (24,19,1,'2',4,2,'2015-04-18','2015-05-01','2,3',900,1000,'1','0','2015-04-20 17:01:11','2015-04-21 10:00:00');
...
CREATE TABLE `course_schedule_detail` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8 COMMENT='排课明细';

/*Data for the table `course_schedule_detail` */

LOCK TABLES `course_schedule_detail` WRITE;

insert  into `course_schedule_detail`(`id`,`teacher_id`,`student_id`,`course_type`,`order_id`,`order_course_id`,`schedule_id`,`date`,`is_finish`,`start_time`,`end_time`,`iseff`,`create_time`,`last_update`) values (48,19,1,'2',16,60,24,'2015-04-20',1,900,1000,'0','2015-04-20 17:01:11','2015-04-20 17:01:44'),(49,19,1,'2',16,60,24,'2015-04-21',1,900,1000,'0','2015-04-20 17:01:12','2015-04-21 10:00:00'),(50,19,1,'2',16,60,24,'2015-04-27',0,900,1000,'0','2015-04-20 17:01:12','2015-04-20 17:01:12'),(51,19,1,'2',16,60,24,'2015-04-28',0,900,1000,'0','2015-04-20 17:01:12','2015-04-20 17:01:12');
...
insert  into `order_course`(`id`,`order_id`,`course_type`,`charger_id`,`status`,`order_attach_id`,`hour`,`cost_hour`,`schedule_hour`,`create_time`,`last_update`) values (60,16,'2',19,'1',0,50,1,4,'2015-04-20 17:00:56','2015-04-21 10:00:00'),(61,16,'1',20,'1',0,50,0,0,'2015-04-20 15:31:02','2015-04-10 22:56:28');
