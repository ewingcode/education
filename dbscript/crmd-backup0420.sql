...
insert  into `course_schedule`(`id`,`teacher_id`,`student_id`,`course_type`,`total_course_hour`,`total_cost_hour`,`start_date`,`end_date`,`week_days`,`start_time`,`end_time`,`status`,`iseff`,`create_time`,`last_update`) values (24,19,1,'2',4,1,'2015-04-18','2015-05-01','2,3',900,1000,'1','0','2015-04-20 17:01:11','2015-04-20 17:01:44');
...
insert  into `order_course`(`id`,`order_id`,`course_type`,`charger_id`,`status`,`order_attach_id`,`hour`,`cost_hour`,`schedule_hour`,`create_time`,`last_update`) values (60,16,'2',19,'1',0,50,0,4,'2015-04-20 17:00:56','2015-04-20 17:02:13'),(61,16,'1',20,'1',0,50,0,0,'2015-04-20 15:31:02','2015-04-10 22:56:28');
...
CREATE TABLE `order_course_hour_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='课时消耗记录';

/*Data for the table `order_course_hour_log` */

insert  into `order_course_hour_log`(`id`,`order_id`,`order_course_id`,`schedule_id`,`schedule_detail_id`,`course_type`,`student_id`,`teacher_id`,`teach_time`,`cost_hour`,`status`,`create_time`,`last_update`,`operator`) values (10,16,60,24,48,'2',1,19,'2015-04-20',1,'1','2015-04-20 17:01:44','2015-04-20 17:01:44',NULL);
