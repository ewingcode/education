...
insert  into `course_schedule`(`id`,`teacher_id`,`student_id`,`course_type`,`date`,`is_finish`,`start_time`,`end_time`,`iseff`,`create_time`,`last_update`) values (9,19,1,'2','2015-04-02',0,1000,1100,'0','2015-04-10 18:13:19','2015-04-10 18:00:05'),(11,19,1,'1','2015-04-02',0,900,1000,'0','2015-04-10 18:13:19','2015-04-10 18:03:50'),(12,19,1,'2','2015-04-03',0,900,1000,'0','2015-04-10 18:13:20','2015-04-10 18:03:52'),(13,19,1,'9','2015-04-02',0,1400,1500,'0','2015-04-10 18:13:22','2015-04-10 18:03:53');
...
CREATE TABLE `order_course` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=60 DEFAULT CHARSET=utf8 COMMENT='签单课程负责人记录表';

/*Data for the table `order_course` */

insert  into `order_course`(`id`,`order_id`,`course_type`,`charger_id`,`create_time`,`last_update`,`status`,`order_attach_id`,`hour`,`cost_hour`) values (58,15,'3',NULL,'2015-04-08 21:29:30','2015-04-08 21:29:30','0',0,50,0),(59,15,'2',NULL,'2015-04-08 21:29:30','2015-04-08 21:29:30','0',0,50,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='签单表';

/*Data for the table `order_info` */

insert  into `order_info`(`id`,`order_no`,`student_id`,`fee`,`order_type`,`status`,`des`,`flow_ins_id`,`start_time`,`end_time`,`grade`,`course_hour`,`cost_course_hour`,`run_status`,`parent_order_id`,`cur_operator`,`is_last`,`iseff`,`create_time`,`last_update`) values (15,'no1111',1,1200000,'0','销售主管审批',NULL,NULL,'2015-04-08 00:00:00','2015-04-30 00:00:00','2',100,NULL,'0',NULL,18,'0','0','2015-04-08 21:29:30','2015-04-08 21:32:59');
...
CREATE TABLE `order_rel_his` (
  ...
  `task_id` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=78 DEFAULT CHARSET=utf8 COMMENT='签单参与者历史表';

/*Data for the table `order_rel_his` */

insert  into `order_rel_his`(`id`,`order_id`,`task_name`,`chargerType`,`operator`,`create_time`,`last_update`,`task_id`) values (77,15,'签约','1',18,'2015-04-08 21:29:30','2015-04-08 21:29:30',1);
...
CREATE TABLE `order_trace` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=116 DEFAULT CHARSET=utf8 COMMENT='签单流程跟踪表';

/*Data for the table `order_trace` */

insert  into `order_trace`(`id`,`order_id`,`task_name`,`role_id`,`user_id`,`operator`,`oper`,`create_time`,`last_update`,`oper_sort`,`task_id`,`transition`) values (114,15,'签约',1,NULL,18,'0','2015-04-08 21:29:30','2015-04-08 21:29:30',NULL,1,'待审批'),(115,15,'销售主管审批',2,NULL,NULL,NULL,'2015-04-08 21:29:30','2015-04-08 21:29:30',NULL,2,NULL);
