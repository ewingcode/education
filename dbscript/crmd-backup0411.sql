...
CREATE TABLE `course_schedule` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='排课';

/*Data for the table `course_schedule` */

LOCK TABLES `course_schedule` WRITE;

insert  into `course_schedule`(`id`,`teacher_id`,`student_id`,`course_type`,`order_id`,`order_course_id`,`date`,`is_finish`,`start_time`,`end_time`,`iseff`,`create_time`,`last_update`,`orderId`,`orderCourseId`) values (20,19,1,'2',16,60,'2015-04-10',0,800,900,'0','2015-04-10 23:09:29','2015-04-10 23:09:29',NULL,NULL);
...
insert  into `order_course`(`id`,`order_id`,`course_type`,`charger_id`,`status`,`order_attach_id`,`hour`,`cost_hour`,`schedule_hour`,`create_time`,`last_update`) values (60,16,'2',19,'1',0,50,NULL,1,'2015-04-10 22:37:19','2015-04-10 23:09:40'),(61,16,'1',20,'1',0,50,NULL,NULL,'2015-04-10 22:37:19','2015-04-10 22:56:28');
