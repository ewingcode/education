...
CREATE TABLE `course_schedule` (
  ...
  `schedule_template_id` int(10) unsigned DEFAULT '0' COMMENT '排课模板id',
...
/*Table structure for table `course_schedule_template` */

DROP TABLE IF EXISTS `course_schedule_template`;

CREATE TABLE `course_schedule_template` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `teacher_id` int(10) unsigned DEFAULT NULL,
  `student_id` int(10) unsigned DEFAULT NULL,
  `course_type` char(2) NOT NULL COMMENT '课程类型',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='排课模板';

/*Data for the table `course_schedule_template` */
...
insert  into `order_course`(`id`,`order_id`,`course_type`,`charger_id`,`status`,`order_attach_id`,`hour`,`cost_hour`,`schedule_hour`,`create_time`,`last_update`) values (60,16,'2',19,'1',0,50,1,1,'2015-04-10 22:37:19','2015-04-11 14:11:02'),(61,16,'1',20,'1',0,50,NULL,NULL,'2015-04-10 22:37:19','2015-04-10 22:56:28');
...
CREATE TABLE `order_course_hour_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='课时消耗记录';
