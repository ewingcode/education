...
var removeData = function(b) { 
	Ext.Msg.confirm("信息确认", "您确认要删除该记录吗？", function(c) {
		if (c == "yes") {
			Ext.Ajax.request( {
				url : "Busi_OrderCourseHour_delete.action",
				params : {
					id : b
				},
				method : "post",
...
var store = new Ext.data.Store( {
	...
	proxy : new Ext.data.HttpProxy( {
		url : 'Busi_OrderCourseHour_pageQuery.action'
	}),
...
function loadGirdStore(){ 
	...
	store.setBaseParam('_QUERY_d_ge_teach_time',Ext.getCmp('QUERY_teach_startTime')
			.getValue()); 
	store.setBaseParam('_QUERY_d_le_teach_time',Ext.getCmp('QUERY_teach_endTime')
			.getValue());  
